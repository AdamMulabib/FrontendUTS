...
export default function Workshop() {
  ...
  return (
    ...
    <section className="flex flex-col md:flex-row items-center justify-between px-16 py-20 max-w-6xl mx-auto">
      ...
      >
        <h2 className="text-3xl font-bold text-[#7B1D3F] mb-10">
          Pelaksanaan IT Workshop
        </h2>
        ...
        <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-500 text-sm flex items-center gap-2">
                    <Calendar size={14} className="text-[#7B1D3F]" /> {w.date}
                  </p>
                  <p className="text-gray-500 text-sm flex items-center gap-2">
                    <Clock size={14} className="text-[#7B1D3F]" /> {w.time}
                  </p>
                  <p className="text-gray-500 text-sm flex items-center gap-2">
                    <MapPin size={14} className="text-[#7B1D3F]" /> {w.location}
                  </p>
                </div>
              </motion.div>
            ))}
          ...
          <div className="flex justify-center">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="bg-white rounded-xl p-4 flex items-center gap-4 shadow-sm w-full md:w-1/2"
            >
              <div className="bg-[#7B1D3F] text-white rounded-lg w-14 h-14 flex items-center justify-center flex-shrink-0">
                {workshops[2].icon}
              </div>
              ...
              <div className="text-left">
                ...
                <p className="text-gray-500 text-sm flex items-center gap-2">
                  <Calendar size={14} className="text-[#7B1D3F]" /> {workshops[2].date}
                </p>
                <p className="text-gray-500 text-sm flex items-center gap-2">
                  <Clock size={14} className="text-[#7B1D3F]" /> {workshops[2].time}
                </p>
                <p className="text-gray-500 text-sm flex items-center gap-2">
                  <MapPin size={14} className="text-[#7B1D3F]" /> {workshops[2].location}
                </p>
              </div>
            </motion.div>
          </div>
        ...
        {faqItems.map((item, i) => (
          ...
          >
            <summary className="flex items-center gap-3 text-gray-700 font-medium text-sm list-none outline-none">
              <span className="text-[#7B1D3F] text-lg font-bold group-open:rotate-180 transition-transform">
                ⌄
              </span>
              {item.title}
            </summary>
